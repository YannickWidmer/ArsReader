...
public class AsyncTaskResponse{
    ...
    public static final int RETRIEVEENTRIES = 0, RETRIEVEARTICLE = 1, WRITENEWENTRIES = 2, WRITEARTICLE = 3;
    ...
    public enum Results{
        OK(R.string.ok) , FAILED(R.string.failed), NETWORKTIMEOUTERROR(R.string.network_timeout_error) ,
